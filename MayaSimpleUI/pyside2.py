"""
Maya UI utilities written in PySide2

"""
__author__ = "Chris Thwaites"
__version__ = "0.1.0"
__maintainer__ = "Chris Thwaites"
...
class SimpleProgressBar:
    ...
    def __init__(self, title=""):
        self.window = cmds.window(title)
        cmds.columnLayout()
        self.progressBar = cmds.progressBar(width=300)
        cmds.showWindow(self.window)

    def update_progress(self, progress):
        cmds.progressBar(self.progressBar, edit=True, progress=progress)

    def update_status(self, status):
        cmds.progressBar(self.progressBar, edit=True, status=status)

    def close(self):
        cmds.deleteUI(self.progressBar)
